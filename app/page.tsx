...
// ─── UI helpers & variants ───────────────────────────────
import { fadeUp, fadeIn, GridLines, GlowBlue, GlowYellow, Divider, SectionLabel } from "@/components/ui";

// ─── Data ────────────────────────────────────────────────
import { courts, stats, steps, torneos, resultados, tarifas, top3Ranking, statusConfig } from "@/data";
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="flex flex-col md:flex-row items-end justify-center gap-4 max-w-3xl mx-auto mb-12">
            ...
            <motion.div className="flex-1 rounded-2xl p-6 flex flex-col items-center gap-3 text-center"
              style={{ backgroundColor: "#0d1e38", border: "1px solid rgba(0,56,168,0.3)", minHeight: "210px" }}
              initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0.1} variants={fadeUp}>
              <span style={{ fontSize: "30px" }}>🥈</span>
              <div className="flex flex-col gap-1">
                <p className="text-white font-bold text-lg" style={{ fontFamily: "var(--font-playfair)" }}>{top3Ranking[1].nombre}</p>
                <span className="text-xs px-2 py-0.5 rounded-full self-center"
                  style={{ fontFamily: "var(--font-dm-sans)", color: "#7a92b8", backgroundColor: "rgba(122,146,184,0.12)", border: "1px solid rgba(122,146,184,0.25)" }}>
                  {top3Ranking[1].categoria}
                </span>
              </div>
              <p className="text-3xl font-bold" style={{ fontFamily: "var(--font-playfair)", color: "#CCFF00" }}>{top3Ranking[1].elo}</p>
              <p className="text-xs" style={{ fontFamily: "var(--font-dm-sans)", color: "var(--color-muted)" }}>{top3Ranking[1].ganados}V · {top3Ranking[1].perdidos}P</p>
            </motion.div>
            {/* 1er lugar */}
            <motion.div className="flex-1 rounded-2xl p-8 flex flex-col items-center gap-3 text-center"
              style={{ backgroundColor: "#0d1e38", border: "1px solid rgba(204,255,0,0.35)", minHeight: "260px", boxShadow: "0 0 40px rgba(204,255,0,0.07)" }}
              initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0} variants={fadeUp}>
              <span style={{ fontSize: "38px" }}>🥇</span>
              <div className="flex flex-col gap-1">
                <p className="text-white font-bold text-xl" style={{ fontFamily: "var(--font-playfair)" }}>{top3Ranking[0].nombre}</p>
                <span className="text-xs px-2 py-0.5 rounded-full self-center"
                  style={{ fontFamily: "var(--font-dm-sans)", color: "#CCFF00", backgroundColor: "rgba(204,255,0,0.1)", border: "1px solid rgba(204,255,0,0.3)" }}>
                  {top3Ranking[0].categoria}
                </span>
              </div>
              <p className="text-4xl font-bold" style={{ fontFamily: "var(--font-playfair)", color: "#CCFF00" }}>{top3Ranking[0].elo}</p>
              <p className="text-xs" style={{ fontFamily: "var(--font-dm-sans)", color: "var(--color-muted)" }}>{top3Ranking[0].ganados}V · {top3Ranking[0].perdidos}P</p>
              <span className="text-xs px-3 py-1 rounded-full font-bold uppercase tracking-wider"
            ...
            {/* 3er lugar */}
            <motion.div className="flex-1 rounded-2xl p-6 flex flex-col items-center gap-3 text-center"
              style={{ backgroundColor: "#0d1e38", border: "1px solid rgba(0,56,168,0.3)", minHeight: "190px" }}
              initial="hidden" whileInView="visible" viewport={{ once: true }} custom={0.2} variants={fadeUp}>
              <span style={{ fontSize: "26px" }}>🥉</span>
              <div className="flex flex-col gap-1">
                <p className="text-white font-bold" style={{ fontFamily: "var(--font-playfair)" }}>{top3Ranking[2].nombre}</p>
                <span className="text-xs px-2 py-0.5 rounded-full self-center"
                  style={{ fontFamily: "var(--font-dm-sans)", color: "#1a56db", backgroundColor: "rgba(26,86,219,0.12)", border: "1px solid rgba(26,86,219,0.25)" }}>
                  {top3Ranking[2].categoria}
                </span>
              </div>
              <p className="text-3xl font-bold" style={{ fontFamily: "var(--font-playfair)", color: "#CCFF00" }}>{top3Ranking[2].elo}</p>
              <p className="text-xs" style={{ fontFamily: "var(--font-dm-sans)", color: "var(--color-muted)" }}>{top3Ranking[2].ganados}V · {top3Ranking[2].perdidos}P</p>
            </motion.div>
          </div>
